    ...
    <div class="row">
        <div class="col-4 col-md-2 mb-3">
            ...
            <ul class="nav flex-column">
                <li class="nav-item mb-2">
                    <a href="<?php echo BASE_URL ?>pages/features.php" class="nav-link p-0 text-body-secondary">Features</a>
                </li>
                <li class="nav-item mb-2">
                    <a href="<?php echo BASE_URL ?>pages/faq.php" class="nav-link p-0 text-body-secondary">FAQ</a>
                </li>
                <li class="nav-item mb-2">
                    <a href="<?php echo BASE_URL ?>pages/pricing.php" class="nav-link p-0 text-body-secondary">Pricing</a>
                </li>
                <li class="nav-item mb-2">
        ...
        <div class="col-md-5 offset-md-1 mb-3 text-center">
            ...
            <ul class="nav justify-content-evenly">
                <li class="nav-item">
                    <a href="https://github.com/Philip-11" class="nav-link text-body-secondary"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-github" viewBox="0 0 16 16">
